...
//         p->variables[p->pos].y = 1;
//         p->variables[p->pos].x = 1;
//         v->num = (int **)n2dcalloc(p->variables[p->pos].y, p->variables[p->pos].x, sizeof(int *));
//         v->y = 1;
//         v->x = 1;
//         for (int y = 0; y < v->y; y++)
//         {
...
//     //     v3->num = (int **)n2dcalloc(v2->y, v2->x, sizeof(int *));
...
//     stack->top = -1;
//     // stack->arr = (var *)n2dcalloc(capacity, capacity, sizeof(var));
...
// void push(Program *p, var *v)
// {
//     printf("pushing to stack : %d \n", p->stack->top);
//     if (isFull(p->stack))
//         return;
//     printf("pushing...\n");
//     p->stack->arr[++p->stack->top] = *v;

//     printf("pushed to stack with: %d, with value: %d \n", p->stack->top, v->num[0][0]);
// }
...
//         for (int x = 0; x < 1; x++)
//         {
//             printf("%d", stack->arr[stack->top].num[y][x]);
//         }
//         printf("\n");
//     }
//     var *variable = &stack->arr[stack->top];
//     stack->top--;
